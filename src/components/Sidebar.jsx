      ...
      {toggle === false ? (
        <div className="h-[95%] w-[8.5%] fixed left-8 top-8 overflow-y-auto bg-[#131313] rounded-2xl transition-all duration-500">
          <div className="flex flex-col text-3xl justify-center items-center mt-4 p-4 gap-8">
            ...
            />
            <Link to="/" className="cursor-pointer transition-all duration-500">
              <img
                src={Homepage}
                alt="Homepage Icon"
                width={50}
        ...
        <div className="h-[95%] w-[22.5%] fixed left-8 top-8 overflow-y-auto bg-[#131313] rounded-2xl transition-all duration-500">
          <div className="flex flex-col text-3xl mt-4 p-4 gap-8 cursor-pointer">
            <div
            ...
            <Link
              to="/"
              className="flex justify-start items-center gap-4 ml-4 cursor-pointer transition-all duration-500"
            >
              <img
                src={Homepage}
                alt="Homepage Icon"
            ...
            <div className="flex justify-start items-center gap-4 ml-4 cursor-pointer transition-all duration-500">
              <img
                src={Search}
                alt="Search Icon"
                width={50}
